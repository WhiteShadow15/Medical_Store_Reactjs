        ...
        <aside id="leftsidebar" className="sidebar">
          <div className="user-info">
            ...
            <div className="info-container">
              ...
              <div className="email">vibhuteha1598@gmail.com</div>
              <div className={this.state.defaultClass}>
                ...
                <ul className="dropdown-menu pull-right">
                  <li>
                    <a href={Config.logoutPageUrl} className=" waves-effect waves-block"   ref = {this.divref2}>
          ...
          <div className="legal">
            <div className="copyright">
              © 2022 - 2023{""} <a href="#">Medical Store Management Syste,</a>.
            </div>
